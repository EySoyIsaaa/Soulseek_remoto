...
<head>
  ...
  <style>
    ...
    .card { display:block; text-decoration:none; color:#fff; background:linear-gradient(160deg,#1c1c1c,#232323); border:1px solid #3b3b3b; border-radius:18px; padding:18px; margin-bottom:14px; box-shadow:0 10px 25px rgba(0,0,0,.25); transition:transform .15s ease,border-color .15s ease; }
    .card:hover { transform: translateY(-2px); border-color:#5a5a5a; }
    .title { font-size:1.2rem; font-weight:700; margin-bottom:8px; }
    .desc { color:#bcbcbc; line-height:1.35; }
    .btn { margin-top:12px; display:inline-block; background:linear-gradient(135deg,#2f80ed,#56a3ff); border-radius:12px; padding:12px 16px; font-weight:700; box-shadow:0 8px 18px rgba(47,128,237,.35); }
  </style>
</head>
<body>
<div class="wrap">
  <h1>👋 Bienvenido al Descargador Privado</h1>
  <p style="color:#bdbdbd; margin:0 0 18px;">Accede rápido a búsqueda o baja tus archivos temporales en un toque.</p>
  ...
  <a class="card" href="/downloads">
    <div class="title">⬇️ Descargar canciones</div>
...
<body>
<div class="wrap">
  <h1>⬇️ Descargar canciones</h1>
  <p style="color:#bdbdbd; margin:0 0 14px;">Aquí verás solo archivos temporales ya bajados por el servidor.</p>
  <div class="bar">
